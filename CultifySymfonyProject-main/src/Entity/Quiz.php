...
public function setDateQuiz(?\DateTimeInterface $DateQuiz): self
{
    ...
    public function calculateScore(): int
    {
        ...
        // Désérialiser les réponses de l'utilisateur
        $userResponses = json_decode($this->getReponseChoisit(), true) ?? [];
    
        foreach ($this->getQuestions() as $question) {
            $correctAnswer = $question->getResponseCorrect();
            $userAnswer = $userResponses[$question->getIdQuestion()] ?? null;
